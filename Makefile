...
XVFB_RUN = 
abs_builddir = /home/prod/Downloads/plank-src
abs_srcdir = /home/prod/Downloads/plank-src
...
#	LANG=C $(GENHTML) --output-directory $(top_builddir)/coveragereport --title "plank 0.11.4" --num-spaces 4 --legend --show-details $(top_builddir)/coverage.info
